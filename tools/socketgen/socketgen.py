            ...
            for acc in accelerator_list:
                for impl in acc.hlscfg:
                    ...
                    if acc.hls_tool == 'stratus_hls' or acc.hls_tool == 'rtl':
                        ...
                        f.write("    port (\n")
                        write_acc_interface(
                            f, acc, dma_width, impl.datatype, "rst", False, False, False)
                        ...
                        f.write("    port (\n")
                        write_acc_interface(
                            f, acc, dma_width, impl.datatype, "rst", False, True, False)
                        ...
                        f.write("    port (\n")
                        write_acc_interface(
                            f, acc, dma_width, impl.datatype, "rst", False, False, True)
                    else:
                        f.write(
                            "  component " +
                            acc.name +
                        ...
                        f.write("    port (\n")
                        write_acc_interface(
                            f, acc, dma_width, impl.datatype, "ap_rst", True, False, False)
                    f.write("    );\n")
    ...
    with open(template_dir + '/genacc.vhd', 'r') as ftemplate:
        for tline in ftemplate:
            ...
            for acc in accelerator_list:
                ...
                f.write("    port (\n")
                write_acc_interface(
                    f, acc, dma_width, "", "acc_rst", False, False, False)
                f.write("    );\n")
                f.write("  end component;\n\n")
                f.write("\n")
                    ...
                    for impl in acc.hlscfg:
                        ...
                        if acc.hls_tool == 'stratus_hls' or acc.hls_tool == 'rtl':
                            f.write(
                                ...
                                "\n")
                            write_acc_port_map(
                                f, acc, dma_width, impl.datatype, "rst", False, False, False, False)
                        else:
                            f.write(
                                "    " +
                                acc.name +
                                ...
                                "_top\n")
                            write_acc_port_map(
                                f, acc, dma_width, impl.datatype, "rst", False, True, False, False)
                        f.write(
                            "  end generate impl_" +
                            impl.name +
                            "_gen;\n\n")
        ...
        for tline in ftemplate:
            if tline.find("-- <<entity>>") >= 0:
                ...
                if is_axi:
                    ...
                    f.write("    )\n")
                    write_acc_port_map(
                        f, acc, dma_width, "", "acc_rst", True, False, False, False)
            else:
                f.write(tline)
