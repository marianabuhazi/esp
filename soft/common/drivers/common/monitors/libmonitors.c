...
#include "soc_locs.h"
    ...
    for (t = 0; t < SOC_NACC; t++) {
        ...
        vals_diff.acc_stats[t].acc_mem_lo =
            sub_monitor_vals(vals_start.acc_stats[t].acc_mem_lo, vals_end.acc_stats[t].acc_mem_lo);
        vals_diff.acc_stats[t].acc_mem_hi =
            sub_monitor_vals(vals_start.acc_stats[t].acc_mem_hi, vals_end.acc_stats[t].acc_mem_hi);
        vals_diff.acc_stats[t].acc_tot_lo =
            sub_monitor_vals(vals_start.acc_stats[t].acc_tot_lo, vals_end.acc_stats[t].acc_tot_lo);
        vals_diff.acc_stats[t].acc_tot_hi =
            sub_monitor_vals(vals_start.acc_stats[t].acc_tot_hi, vals_end.acc_stats[t].acc_tot_hi);
    }
